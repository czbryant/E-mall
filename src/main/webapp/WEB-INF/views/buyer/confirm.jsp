	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div class="span2" style="height: 80px;text-align: center;margin-top: 25px;margin-left: 10px;">
					<button class="btn btn-large btn-danger" style="width:150px;">确认收货 <i class="icon-hand-right icon-white"></i></button>
				</div>
				<div class="span2" style="height: 80px;text-align: center;margin-top: 25px;margin-left: 10px;">
			...
			<c:if test="${!empty confirmitems}">
				<table class="table table-hover">
	              ...
	              <tbody>
					...
					<c:forEach var="order" items="${confirmitems}" varStatus="idx">
						<script>
							$(function(){
								$("#${idx.index}_btn").click(function(){
									$.ajax(
											{
												url:"<%=request.getContextPath()%>/BuyerController/ConfirmArrived?id=${order.id}",
												type:"post",
						...
						<tr id="${idx.index}_tr">
		                  ...
		                  <td>
		                  	<button class="btn btn-danger" id="${idx.index}_btn">确认</button>
		                  </td>
		                </tr>
					</c:forEach>              	
